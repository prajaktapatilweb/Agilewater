...
export default function SMinfo() {
    var DetailObject = [
        ...
        {
            type: 'para',
            text: [<span>Check out our other <Link href=""> Online Advanced Certified Scrum Master Certification </Link>, <Link href="">Scrum Master Certification Online Course</Link> & <Link href="">Scrum Quiz</Link>.</span>]
        }
