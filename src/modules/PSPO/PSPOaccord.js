...
export default function PSPOaccord() {
    var DetailObject = [
        ...
        },
        {
            ...
            para: (
                <span>The alternative to PSPO certification is <Link href=''>Certified Scrum Product Owner</Link> Certification which is provided by Scrum Alliance Certification body.</span>
            )
        }
    ]
