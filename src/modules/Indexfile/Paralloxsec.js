                    ...
                    <Container>
                        <Grid container spacing={3} className='section' alignItems='center' sx={{ textAlign: 'center' }}>
                            ...
                            <Grid item xs={12} md={7} sx={{ textAlign: 'left' }}>
                                <Typography sx={{ color: 'white', fontSize: 30, fontWeight: 'bold' }} gutterBottom>Get hired for your dream job!</Typography>

                                <Typography variant='h3' sx={{ color: 'white' }}>Join a truly global team, united by a singular passion for science.</Typography>
                            ...
                            <Grid item xs={12} md={5}>
                                <Box className="cardx">
                                    <Button variant='h1' sx={{ fontSize: 18 }} endIcon={< KeyboardDoubleArrowRightIcon />}>
