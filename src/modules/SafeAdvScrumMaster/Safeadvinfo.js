...
export default function Safeadvinfo() {
    var DetailObject =
        [
            { type: 'title', text: ' SAFe Advanced Scrum Master Training Course(SASM) Overview' },
            {
                type: 'para',
                text: [
            ...
            { type: 'title', text: '  Benefits of Getting Certified with the SAFe Advanced Scrum Master Certification:' },
            {
                type: 'items',
                text:
                    [,
